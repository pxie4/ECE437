...
ok_sdk_loc = "C:\\Program Files\\Opal Kelly\\FrontPanelUSB\\API\\Python\\3.7\\x64"
...
SerialStatus=dev.OpenBySerial("1839000NIG")      # open USB communication with the OK board
